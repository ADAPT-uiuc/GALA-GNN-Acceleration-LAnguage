...
typedef int val_int_t;
    ...
    using namespace std;
// IR classes
#include "../build/ir/data.h"
#include "../build/ir/compute.h"
...
int main(int argc, char **argv) {
    // Init point counter
    std::vector<CIRNode*> *program = new vector<CIRNode*>;
	std::vector<RelationEdge*> *dependencies = new vector<RelationEdge*>;
	std::vector<RelationEdge*> *associations = new vector<RelationEdge*>;
	std::vector<TransformEdge*> *transforms = new vector<TransformEdge*>;

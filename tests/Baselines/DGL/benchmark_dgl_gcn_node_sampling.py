...
def full_trainer(graph,
    ...
    with graph.local_scope():
        ...
        for epoch in range(n_epochs):
            ...
            # print("Memory use1:", torch.cuda.max_memory_allocated(device=None))

            if train_model:
                # print(train_mask.shape, logits.shape, labels.shape)
                # print("device: ", labels.get_device(), logits.get_device(), train_mask.get_device())

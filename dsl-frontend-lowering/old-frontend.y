...
DataNode* createDataNode(int rm_dtype, pair<int,int> infoDims, bool levelIndependence, string name, NumTypes indexType, NumTypes edgeType, NumTypes valueType){
    DataInfo* info = new DataInfo(RM_DTYPE);
...
void addAggregate_CIR(DataNode* defaultInput, DataNode* graph){
    ...
    DataNode* outputData = createDataNode(RM_DTYPE, {-1,-2}, true, "res-aggregate", INT32, INT32, F32);
...
void addFFN_CIR(DataNode* defaultInput){
    ...
    DataNode* weightData = createDataNode(RM_DTYPE, {-2,-3}, true, "Weight1", INT32, INT32, F32);
    dataNodeMap["Weight1"] = weightData;
    // Res DIR
    DataNode* resData = createDataNode(RM_DTYPE, {-1,-3}, true, "res-weight", INT32, INT32, F32);
...
void addNormalization_CIR(DataNode* defaultInput){
    ...
    DataNode* normData = createDataNode(RM_DTYPE, {-1, 1}, true, "norm", INT32, INT32, F32);
...
void addNormCalc_CIR(DataNode* defaultInput, DataNode* featData){
    ...
    DataNode* normFeat1Data = createDataNode(RM_DTYPE, {-1, 602}, true, "res-norm", INT32, INT32, F32);
...
void addReLU_CIR(DataNode* defaultInput){
    ...
    DataNode* reluData = createDataNode(RM_DTYPE, {-1, 32}, true, "res-relu", INT32, INT32, F32);
...
void addDegrees_CIR(DataNode* defaultInput, DataNode* graph){
    ...
    DataNode* onesData = createDataNode(RM_DTYPE, {-1, 1}, true, "ones", INT32, INT32, F32);
...
void mulScalarEPS_CIR(DataNode* featData){
    ...
    DataNode* scalarEpsData = createDataNode(RM_DTYPE, {-1, -2}, true, "res-mulScalarEPS", INT32, INT32, F32);
...
void addScalarEPS_CIR(DataNode* defaultInput, DataNode* aggrOutput){
    ...
    DataNode* normFeatData = createDataNode(RM_DTYPE, {-1, -2}, true, "res-addScalarEPS", INT32, INT32, F32);
...
// R side
	...
	// Weight as a matrix in the DIR
    DataNode* attenRWeightData = createDataNode(CM_DTYPE, {-2, 1}, true, "attenRWeight1", INT32, INT32, F32);
	// Res DIR
    DataNode* attenRData = createDataNode(RM_DTYPE, {-1, 1}, true, "attenR", INT32, INT32, F32);

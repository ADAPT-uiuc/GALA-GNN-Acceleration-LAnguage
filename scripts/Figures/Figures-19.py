...
def evalDGL(args):
    ...
    outfile = open(args.stat_log + "_" + args.hw + "_DGL_memory.csv", 'w+')
    ...
    for dset in dataset_list:
        for model in models:
            ...
            job_args = ['python',
                        ...
                        '--layers', str(1),
                        '--n-epochs', str(100),
                        "--logfile", args.stat_log + "_" + args.hw + "_DGL_memory.csv",
                        "--device", "cuda",
                        "--discard", str(5)]
            outfile = open(args.stat_log + "_" + args.hw + "_DGL_memory.csv", 'a+')

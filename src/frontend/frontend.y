...
// extern vector<CIRNode*>* program_glob = &program;
int iters = -1;
int debug = 0;
int numLayers = 0;
TrainingLoopNode* mainTrainingLoop = new TrainingLoopNode(iters == -1 ? 100 : iters);
...
data_transform : data_var ASSIGN data_var DOT SET_UNDIRECTED LPAREN bool RPAREN SEMICOLON
    ...
    | data_var ASSIGN data_var DOT COLTILE LPAREN INTEGER RPAREN SEMICOLON 
    {
        ...
        transformedGraphInfo->addOpt(COL_TILE_DOPT, $7);

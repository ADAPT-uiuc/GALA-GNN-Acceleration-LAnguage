...
public:
    ...
    void addInputData(std::any new_input){
        this->inputData.push_back(new_input);
    }
    void addOutputData(std::any new_output){
        this->outputData.push_back(new_output);
    }
};
...
public:
    IfNode(int point, std::string condition) : ComputeNode(IF, point){
    ...
    void addTrue(ComputeNode newNode){
        this->truePath.push_back(newNode);
    }
    void addElse(ComputeNode newNode){
        this->elsePath.push_back(newNode);
    }
};
...
public:
    TrainingLoopNode(int point, int numIter) : ComputeNode(TRAIN, point){
        this->numIter = numIter;
        this->stepValid = numIter;
    }
    TrainingLoopNode(int point, int numIter, int stepValid) : ComputeNode(TRAIN, point){
        this->numIter = numIter;
    ...
    void addLoopNode(ComputeNode newNode){
        this->loop.push_back(newNode);
    }
